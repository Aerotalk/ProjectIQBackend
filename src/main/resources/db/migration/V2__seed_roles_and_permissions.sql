-- Seed Roles
INSERT INTO roles (role_id, role_name, system_role, description, status, created_at, updated_at)
VALUES 
...
INSERT INTO permission_groups (permission_group_id, group_name, description, created_at, updated_at)
VALUES 
...
BEGIN
    ...
    INSERT INTO role_permission_groups (role_group_id, role_id, permission_group_id, data_scope, created_at, updated_at)
    VALUES 
